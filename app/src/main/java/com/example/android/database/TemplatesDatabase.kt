...
@Database(
    entities = [TrainingTemplate::class, TrainingWeek::class, TrainingDay::class, Exercise::class, TemporaryExercise::class,
    IdStorageEntity::class], version = 8, exportSchema = false
)
